---
layout: post
title: "Reflections After I Left My Job"
author: kesha
date: 2025-11-13
cover: assets/images/reflection-2.jpg
tags: [personal, reflections, career-break, slow-living]
...
<figure class="kg-card kg-image-card">
    <img src="{{ site.baseurl }}assets/images/reflection-1.jpg" alt="Slow mornings with chai and fields for company" style="max-width: 70%; display: block; margin: 0 auto;">
    <figcaption style="text-align: center; font-size: 1.1rem; font-weight: 500;">A calm mind is the best mind! ❤️ </figcaption>
</figure>
...
<figure class="kg-card kg-image-card">
    <img src="{{ site.baseurl }}assets/images/reflection-3.jpg" alt="A rainy-day wander, nowhere to rush" style="max-width: 70%; display: block; margin: 0 auto;">
    <figcaption style="text-align: center; font-size: 1.1rem; font-weight: 500;">Cooking is new meditation.</figcaption>
</figure>
...
<figure class="kg-card kg-image-card">
    <img src="{{ site.baseurl }}assets/images/reflection-4.jpg" alt="Farm walks that smell like quiet and fresh greens" style="max-width: 70%; display: block; margin: 0 auto;">
    <figcaption style="text-align: center; font-size: 1.1rem; font-weight: 500;">Peaceful evening farm walks!</figcaption>
</figure>
...
<figure class="kg-card kg-image-card">
    <img src="{{ site.baseurl }}assets/images/reflection-5.jpg" alt="Taking it all in, one mountain breeze at a time" style="max-width: 70%; display: block; margin: 0 auto;">
    <figcaption style="text-align: center; font-size: 1.1rem; font-weight: 500;">Slow mornings in the farm.</figcaption>
</figure>
